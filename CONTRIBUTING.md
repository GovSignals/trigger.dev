...
- [pnpm package manager](https://pnpm.io/installation) version 11.5.3
...
4. Run `corepack enable` to use the correct version of pnpm (`11.5.3`) as specified in the root `package.json` file.

...
// ../../node_modules/.pnpm/esbuild@0.23.0/node_modules/esbuild/lib/main.js
var require_main = __commonJS({
  "../../node_modules/.pnpm/esbuild@0.23.0/node_modules/esbuild/lib/main.js"(exports, module) {
    "use strict";
    init_esm();
      ...
      if (/\.zip\//.test(binPath)) {
        ...
        if (pnpapi) {
          ...
          const binTargetPath = path.join(
            ...
            ".cache",
            "esbuild",
            `pnpapi-${pkg.replace("/", "-")}-${"0.23.0"}-${path.basename(subpath)}`
          );
...
// ../../packages/cli-v3/dist/esm/utilities/logger.js
init_esm();
...
//# sourceMappingURL=chunk-4BOGD3BU.mjs.map
